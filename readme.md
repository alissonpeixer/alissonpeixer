...
Hi, I'm Alisson. I am a full-stack developer from Brazil. Contact me if you have some questions!
...
![My Skills](https://skillicons.dev/icons?i=js,html,css,ts,nodejs)<br>
![My Skills](https://skillicons.dev/icons?i=tailwind,materialui,angular,express,react)<br>
![My Skills](https://skillicons.dev/icons?i=vite,nextjs,java,python,docker)<br>
![My Skills](https://skillicons.dev/icons?i=prisma,sqlite,mongodb,mysql,bash)<br>

**Other Technologies & Databases:** ADVPL, TLPP, SQL Server, Oracle, Expo.

#### 🛠️ Tools:
![My Skills](https://skillicons.dev/icons?i=github,git,vscode,vim,heroku,vercel,figma,pr,ps)<br>

**Additional Tools:** Obsidian, Claude Code, Cursor, ChatGPT.
